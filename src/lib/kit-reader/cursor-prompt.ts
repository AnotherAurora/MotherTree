...
1. Read the kit pack (skill layers, standalone enlightens, atmEligible talents, ignore list,
   ...
   hasEnjoyClause / hasStealClause / hasDevourClause).
2. Propose ATM + local rows for Path Carver (enlighten replace-vs-add;
   ...
   [{Devour}: …] / {Devour} effects → copyProviderGroupName "2x Devour", triggerConditionTagName null
   (never Special.When.Devour or Special.Cause.Devour); insert CLI adds "Devour" to metadata.
